...
output.dir <- "./res/FIG3/GOKEGG/Deg/"
# output.dir <- "./res/FIG3/GOKEGG/Syn/"
...
gene.dat.sign <- read.csv("./res/FIG3/v/gene_data_sign_deg.csv")
# gene.dat.sign <- read.csv("./res/FIG3/v/gene_data_sign_syn.csv")
